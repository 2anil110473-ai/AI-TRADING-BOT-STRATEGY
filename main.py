...
def exit_allowed():
    ...
    # =========================================
    # OLD POSITIONS EXIT AFTER 9:20
    # =========================================

    return "09:20" <= current <= "15:30"
...
def buy_allowed():
    ...
    # ONLY POSITION MANAGEMENT
    # =========================================

    # =========================================
    # 9:25–3:30
    # NEW BUY ENTRIES ALLOWED
    # =========================================

    return "09:25" <= current <= "15:30"
...
""")
                    ...
                    # =============================================
                        ...
                        exit_reason = "GAP DOWN DEFENSIVE EXIT"
                    ...
                    # =============================================
                        ...
                        and result["resistance_rejection"]

                        and price <= (trailing_sl * 0.998)

                    ):

                        exit_reason = "CONFIRMED TRAILING RESISTANCE REVERSAL"

                    # =============================================
                    # TRAILING STOPLOSS SAFETY NET
                    # =============================================
...
""")
                ...
                btst_safe = (
                    ...
                    and price > result["vwap"]

                    and not result["resistance_rejection"]
